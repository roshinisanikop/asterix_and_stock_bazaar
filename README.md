...
3) Use the following team naming format when you create your team on GitHub: spring25-lab1-GitHubid1-Githubid2. For example, spring24-lab1-alice-bob for a group of two. For a single group team, use spring25-lab1-alice as an example team name for a student with github id alice. If you already chose a different format for your team, edit your team name to the above format. 
